...
sealed class EventosListUiState {
    object Loading : EventosListUiState()
    data class Success(val enCurso: List<Evento>, val proximos: List<Evento>) : EventosListUiState()
    data class Error(val message: String) : EventosListUiState()
}
